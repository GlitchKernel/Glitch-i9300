...
mali_dvfs_table mali_dvfs[MALI_DVFS_STEPS]={
	...
	{350   ,1000000   ,  900000}, // L5 0.950
	{266   ,1000000   ,  850000}, // L6 0.900
	{160   ,1000000   ,  775000}, // L7 0.875
	{108   ,1000000   ,  775000}, // L8 0.850
	{54    ,1000000   ,  775000}, // L9 0.825
};
...
mali_bool init_mali_dvfs_status(int step)
{
	...
	*/
	...
	/*Adding manual OC values while the interface doesn't work
